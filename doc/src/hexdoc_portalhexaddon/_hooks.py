...
import hexdoc_portalhexaddon

from .__gradle_version__ import FULL_VERSION, GRADLE_VERSION
from .__version__ import PY_VERSION


class PortalHexAddonPlugin(ModPluginImpl):
    @staticmethod
    @hookimpl
    def hexdoc_mod_plugin(branch: str) -> ModPlugin:
        return PortalHexAddonModPlugin(branch=branch)


class PortalHexAddonModPlugin(ModPluginWithBook):
    @property
    @override
    def modid(self) -> str:
        return "portalhexaddon"
    ...
    def jinja_template_root(self) -> tuple[Package, str]:
        return hexdoc_portalhexaddon, "_templates"
